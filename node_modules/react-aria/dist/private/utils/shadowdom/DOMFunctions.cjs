...
$parcel$export(module.exports, "getPropagationTargets", function () { return $da02ee888921bc9e$export$da7af4355d792141; });
...
function $da02ee888921bc9e$export$da7af4355d792141(from, to) {
    ...
    if (to === null) return [];
    to = to ?? (0, $49582955cc364b1c$exports.getOwnerWindow)(from);
    let targets = [
        to
    ];
    if (!(0, $doPez$reactstatelyprivateflagsflags.shadowDOM)() || !from || from === to) return targets;
    ...
    while((0, $49582955cc364b1c$exports.isShadowRoot)(current) && current !== toRoot){
