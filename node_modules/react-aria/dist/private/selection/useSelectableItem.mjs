...
function $f6ba6936bfd098a0$export$ecf600387e221c37(options) {
    ...
    if (collectionItemProps) {
        ...
        itemPressProps[key] = (0, $a4e76a5424781910$export$e08e3b67e392101e)(itemPressProps[key], collectionItemProps[key]);
    }
    ...
    let mergedItemProps = (0, $bbaa08b3cd72f041$export$9d1611c77c2fe928)(// oxlint-disable-next-line react/react-compiler
