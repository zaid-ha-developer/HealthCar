...
function $0d8cf6a15fe85601$export$ecf600387e221c37(options) {
    ...
    let collectionId = (0, $8f207f199487227b$export$6aeb1680a0ae8741)(manager.collection);
    ...
    itemPressProps = (0, $64c36edd757dfa16$export$9d1611c77c2fe928)(itemPressProps, {
        onPressStart (e) {
    ...
    if (collectionItemProps) {
        ...
        itemPressProps[key] = (0, $2cf8bb4b9e45dc81$export$e08e3b67e392101e)(itemPressProps[key], collectionItemProps[key]);
    }
    ...
    let mergedItemProps = (0, $64c36edd757dfa16$export$9d1611c77c2fe928)(// oxlint-disable-next-line react/react-compiler
    ...
    let isChildInteraction = (target)=>{
        ...
        return (0, $ee5e22534121197a$export$bebd5a1431fec25d)(target);
    };
