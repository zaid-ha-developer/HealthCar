...
import {useContextMenu as $6ed66bff9bbb75e5$export$2464060fb1e12fa6} from "../interactions/useContextMenu.js";
...
import {useEffect as $3fdgD$useEffect} from "react";
...
function $5b0efffb5b3e0cc9$export$dc9c12ed27dd1b49(props, state, ref) {
    ...
    let { contextMenuProps: contextMenuProps } = (0, $6ed66bff9bbb75e5$export$2464060fb1e12fa6)({
        onContextMenu (e) {
    ...
    (0, $3fdgD$useEffect)(()=>{
        ...
        if (state.isOpen && trigger === 'contextMenu') {
            let onContextMenu = (e)=>{
                ...
                if ((e.button === 2 || e.button === 0 && e.ctrlKey === true) && (0, $d8ac7ed472840322$export$e58f029f0fbfdb29)(e) === document.body) state.close();
            };
