...
function $d51706f903be7eab$export$1315d136e6f7581(segment, state, ref) {
    ...
    (0, $600b3cf69ae46262$export$90fc3a17d93f704c)(documentRef, 'selectionchange', ()=>{
        ...
        if (selection?.anchorNode && (0, $23f2114a1b82827e$export$4282f70798064fe0)(ref.current, selection?.anchorNode) && (0, $23f2114a1b82827e$export$cd4e5573fbe2b576)() === ref.current) selection.collapse(ref.current);
    });
