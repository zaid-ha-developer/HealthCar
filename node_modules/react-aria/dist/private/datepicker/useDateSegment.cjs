...
function $76567d92a57bde85$export$1315d136e6f7581(segment, state, ref) {
    ...
    (0, $6e76e65001bbcda2$exports.useEvent)(documentRef, 'selectionchange', ()=>{
        ...
        if (selection?.anchorNode && (0, $da02ee888921bc9e$exports.nodeContains)(ref.current, selection?.anchorNode) && (0, $da02ee888921bc9e$exports.getActiveElement)() === ref.current) selection.collapse(ref.current);
    });
