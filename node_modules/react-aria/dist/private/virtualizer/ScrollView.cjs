...
function $c3885d691318bb9e$export$2ea0c4974da4731b(props, ref) {
    ...
    (0, $bNhn7$react.useEffect)(()=>{
        return (0, $49582955cc364b1c$exports.addEvent)((0, $da02ee888921bc9e$exports.getPropagationTargets)(ref.current, (0, $49582955cc364b1c$exports.getOwnerDocument)(ref.current)), 'scroll', onScroll, true);
    }, [
        onScroll,
        ref
    ]);
