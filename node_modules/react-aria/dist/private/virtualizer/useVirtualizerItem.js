import {isElementVisible as $7570c7c1cd2bea0b$export$e989c0fffaa6b27a} from "../utils/isElementVisible.js";
...
import {useCallback as $7P2XF$useCallback, useEffect as $7P2XF$useEffect} from "react";
...
function $50fb5bc04a398332$export$1da781778207e0a2(options) {
    ...
    let updateSize = (0, $7P2XF$useCallback)(()=>{
        if (key != null && ref.current) {
            ...
            if (!(0, $7570c7c1cd2bea0b$export$e989c0fffaa6b27a)(ref.current)) return;
    ...
    (0, $53fed047b798be36$export$e5c5a5f917a5871c)(()=>{
        if (layoutInfo === null || layoutInfo === void 0 ? void 0 : layoutInfo.estimatedSize) updateSizeEvent();
    });
