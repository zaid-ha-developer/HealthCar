    ...
    let pressProps = (0, $kyYSz$react.useMemo)(()=>{
        ...
        let pressProps = {
            onKeyDown (e) {
                if ($1d003dcb6308cd89$var$isValidKeyboardEvent(e.nativeEvent, e.currentTarget) && (0, $da02ee888921bc9e$exports.nodeContains)(e.currentTarget, (0, $da02ee888921bc9e$exports.getEventTarget)(e))) {
                    ...
                    let pressUp = (e)=>{
                        if ($1d003dcb6308cd89$var$isValidKeyboardEvent(e, originalTarget) && !e.repeat && (0, $da02ee888921bc9e$exports.nodeContains)(originalTarget, (0, $da02ee888921bc9e$exports.getEventTarget)(e)) && state.target) triggerPressUpEvent($1d003dcb6308cd89$var$createEvent(state.target, e), 'keyboard');
                    };
        ...
        if (typeof PointerEvent !== 'undefined') {
            ...
            pressProps.onTouchEnd = (e)=>{
                ...
                } else if (state.isOverTarget && state.pointerType != null) shouldStopPropagation = triggerPressEndEvent($1d003dcb6308cd89$var$createTouchEvent(state.target, e), state.pointerType, false);
                if (shouldStopPropagation) e.stopPropagation();
                state.isPressed = false;
                state.activePointerId = null;
                state.isOverTarget = false;
            ...
            pressProps.onTouchCancel = (e)=>{
                if (!(0, $da02ee888921bc9e$exports.nodeContains)(e.currentTarget, (0, $da02ee888921bc9e$exports.getEventTarget)(e))) return;
                e.stopPropagation();
                if (state.isPressed) cancelEvent($1d003dcb6308cd89$var$createTouchEvent(state.target, e));
            };
            let onScroll = (e)=>{
                if (state.isPressed && (0, $da02ee888921bc9e$exports.nodeContains)((0, $da02ee888921bc9e$exports.getEventTarget)(e), state.target)) cancelEvent({
...
function $1d003dcb6308cd89$var$shouldPreventDefaultKeyboard(target, key) {
    ...
    if ((0, $d0b4a781cf26e80b$exports.isMac)() && key === 'Enter') return false;
    if (target instanceof HTMLInputElement) {
        ...
        return false;
        return !$1d003dcb6308cd89$var$isValidInputKey(target, key);
    }
