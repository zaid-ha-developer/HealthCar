...
$parcel$export(module.exports, "ScrollAnchorTracker", function () { return $e06c1e621ca9099b$export$8ce0fdedc36cb6b; });
/*
 ...
 */ const $e06c1e621ca9099b$var$MIN_ANCHOR_OVERLAP = 4;
function $e06c1e621ca9099b$var$dimensionForAxis(axis) {
    return axis === 'x' ? 'width' : 'height';
}
function $e06c1e621ca9099b$export$413719533c5919c9(anchor, axis, getLayoutInfo, visibleRect, contentSize) {
    ...
    let dimension = $e06c1e621ca9099b$var$dimensionForAxis(axis);
...
function $e06c1e621ca9099b$export$69fb4c6de5f339b7(edge, axis, visibleRect, visibleLayoutInfos, isAnchorable = ()=>true) {
    let dimension = $e06c1e621ca9099b$var$dimensionForAxis(axis);
    let best = null;
    for (let [key, layoutInfo] of visibleLayoutInfos){
        ...
        if (layoutInfo.rect.area > 0 && overlap >= $e06c1e621ca9099b$var$MIN_ANCHOR_OVERLAP) {
...
function $e06c1e621ca9099b$export$c74597e403428eac(edge, axis, contentSize, previousVisibleRect) {
    if (edge === 'start') return 0;
    let dimension = $e06c1e621ca9099b$var$dimensionForAxis(axis);
    return Math.max(0, contentSize[dimension] - previousVisibleRect[dimension]);
}
function $e06c1e621ca9099b$export$f644bffd4937530e(visibleRect, contentSize, edge, axis, threshold) {
...
function $e06c1e621ca9099b$export$dcb80b718ca193d7(edge, axis, anchor, wasNearAnchorEdge, isScrolling, itemSizeChanged, contentSizeDelta, getLayoutInfo, previousVisibleRect, contentSize) {
    let withTarget = (target)=>axis === 'x' ? new (0, $2bdd626d0eea82c5$exports.Rect)(target, previousVisibleRect.y, previousVisibleRect.width, previousVisibleRect.height) : new (0, $2bdd626d0eea82c5$exports.Rect)(previousVisibleRect.x, target, previousVisibleRect.width, previousVisibleRect.height);
    if (anchor) {
        let target = $e06c1e621ca9099b$export$413719533c5919c9(anchor, axis, getLayoutInfo, previousVisibleRect, contentSize);
        if (target != null) return withTarget(target);
    }
    if (wasNearAnchorEdge && !isScrolling && (!itemSizeChanged || contentSizeDelta > 0)) {
        let target = withTarget($e06c1e621ca9099b$export$c74597e403428eac(edge, axis, contentSize, previousVisibleRect));
        return target.equals(previousVisibleRect) ? null : target;
    }
    return null;
}
class $e06c1e621ca9099b$export$8ce0fdedc36cb6b {
   ...
   */ captureBeforeLayout(anchorInfo, preLayoutInfos, visibleRect) {
        ...
        return $e06c1e621ca9099b$export$69fb4c6de5f339b7(anchorInfo.edge, anchorInfo.axis, visibleRect, preLayoutInfos, anchorInfo.isAnchorable);
    }
    /**
   ...
   */ resolveAfterLayout(options) {
        ...
        if (!wasSettlingLastPass) this.wasNearAnchorEdge = $e06c1e621ca9099b$export$f644bffd4937530e(previousVisibleRect, previousContentSize, anchorInfo.edge, anchorInfo.axis, anchorInfo.threshold);
        ...
        let wasNearAnchorEdge = isFirstAnchoredLayout || wasSettlingLastPass && wasNearAnchorEdgeLastPass || $e06c1e621ca9099b$export$f644bffd4937530e(previousVisibleRect, previousContentSize, anchorInfo.edge, anchorInfo.axis, anchorInfo.threshold);
        ...
        return $e06c1e621ca9099b$export$dcb80b718ca193d7(anchorInfo.edge, anchorInfo.axis, effectiveAnchor, wasNearAnchorEdge, isScrolling, itemSizeChanged, contentSizeDelta, getLayoutInfo, previousVisibleRect, contentSize);
    }
    constructor(){
        this.hasSnappedToEdge = false;
        this.hadEstimatedVisibleItems = false;
...
//# sourceMappingURL=ScrollAnchor.cjs.map
